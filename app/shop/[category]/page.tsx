...
// ISR CONFIGURATION - Like @Cacheable with shorter TTL for e-commerce
        ...
        <main>
          ...
          <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg mb-8">
            <h2 className="text-lg font-semibold text-orange-900 mb-2">
              🛒 ISR E-commerce Cache Strategy
            </h2>
            <div className="text-sm text-orange-800 space-y-1">
              <p>
                <strong>Cache TTL:</strong> 30 minutes (product availability and prices change frequently)
              </p>
              <p>
                <strong>Strategy:</strong> Serve cached page while revalidating in background (like @Cacheable with async refresh)
              </p>
              <p>
                <strong>Last Updated:</strong> {new Date().toLocaleString()} (when this page was generated)
              </p>
            </div>
          </div>
